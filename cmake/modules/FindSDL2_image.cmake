...
IF(NOT SDL2_image_BUILDING_LIBRARY)
    IF(NOT ${SDL2_image_INCLUDE_DIR} MATCHES ".framework")
        ...
        # necessarily need it.
        FIND_LIBRARY(SDL2_image_MAIN_LIBRARY
                NAMES SDL2_image_main
                HINTS
                $ENV{SDL2_imageDIR}
                PATH_SUFFIXES ${PATH_SUFFIXES}
                PATHS ${SDL2_image_SEARCH_PATHS}
...
IF(SDL2_image_LIBRARY_TEMP)
    # For SDL2main
    IF(NOT SDL2_image_BUILDING_LIBRARY)
        IF(SDL2_image_MAIN_LIBRARY)
            SET(SDL2_image_LIBRARY_TEMP ${SDL2_image_MAIN_LIBRARY} ${SDL2_image_LIBRARY_TEMP})
        ENDIF(SDL2_image_MAIN_LIBRARY)
    ENDIF(NOT SDL2_image_BUILDING_LIBRARY)
