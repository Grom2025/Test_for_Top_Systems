...
FIND_PATH(SDL2_ttf_INCLUDE_DIR SDL.h
        HINTS
        $ENV{SDL2_ttfDIR}
...
IF(NOT SDL2_ttf_BUILDING_LIBRARY)
    IF(NOT ${SDL2_ttf_INCLUDE_DIR} MATCHES ".framework")
        ...
        # necessarily need it.
        FIND_LIBRARY(SDL2_ttf_MAIN_LIBRARY
                NAMES SDL2_ttf_main
                HINTS
                $ENV{SDL2_ttfDIR}
                PATH_SUFFIXES ${PATH_SUFFIXES}
...
IF(SDL2_ttf_LIBRARY_TEMP)
    # For SDL2main
    IF(NOT SDL2_ttf_BUILDING_LIBRARY)
        IF(SDL2_ttf_MAIN_LIBRARY)
            SET(SDL2_ttf_LIBRARY_TEMP ${SDL2_ttf_MAIN_LIBRARY} ${SDL2_ttf_LIBRARY_TEMP})
        ENDIF(SDL2_ttf_MAIN_LIBRARY)
    ENDIF(NOT SDL2_ttf_BUILDING_LIBRARY)
    ...
    SET(SDL2_ttf_LIBRARY ${SDL2_ttf_LIBRARY_TEMP} CACHE STRING "Where the SDL2 Library can be found")
